...
public class DonationWindow : Dialog {
	public DonationWindow() {
		...
		btn_donate_paypal.clicked.connect(()=>{
			xdg_open("https://www.paypal.com/cgi-bin/webscr?business=teejeetech@gmail.com&cmd=_xclick&currency_code=USD&amount=10&item_name=Disk Manager Indicator%20Donation");
		});
